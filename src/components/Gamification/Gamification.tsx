            ...
            <div className="gamification__modal__content" ref={contentRef}>
              ...
              <div className="gamification__modal__content_main">
                <div className="gamification__modal__content__header">
                  {points === 1 ? (
                    <>You&nbsp;have&nbsp;just&nbsp;made&nbsp;your&nbsp;first&nbsp;comment!<br /> 9 more to claim your reward!</>
                  ) : points === 5 ? (
                    <>5 comments, halfway to your BZZ reward!</>
                  ) : points === 10 ? (
                    <>Congratulations, you’ve made 10 comments and earned your BZZ. <br />Start your own node and participate in the Swarm network!</>
                  ) : points > 10 ? (
                    <></>
                  ) : (
                    <></>
