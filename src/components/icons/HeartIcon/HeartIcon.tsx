...
const HeartIcon: React.FC<HeartIconProps> = ({ color, empty }) => {
  return empty ? (
    <svg
      width="40"
      height="40"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_5157_2804"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_5157_2804"
            result="shape"
          />
        </filter>
      </defs>
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            mode="normal"
            in2="BackgroundImageFix"
            result="effect1_dropShadow_5157_2822"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_5157_2822"
            result="shape"
          />
        </filter>
      </defs>
