...
const Message: React.FC<MessageProps> = ({
  ...
  const likeMessage = async () => {
    ...
    const rep = await chat.sendMessage(ownAddress, topic, messageObj, stamp, privKey);
  ...
  return (
    ...
    >
      ...
      <div className="message__right-side">
        ...
        >
          {data.username} &nbsp;
          <p className="message__right-side__name-and-time__time">{formatTime(data.timestamp)}</p>
        </div>
