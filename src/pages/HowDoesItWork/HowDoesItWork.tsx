    ...
    <div className="how-does-it-work-page">
      ...
      <div className="how-does-it-work-page__content">
        ...
        <div className="how-does-it-work-page__box">
          ...
          <div className="how-does-it-work-page__box__content">Each comment you write brings you one step closer to your own Swarm node!</div>
          <div>
        ...
        <div className="how-does-it-work-page__box">
          ...
          <div className="how-does-it-work-page__box__content">
            After submitting 10 comments, you’ll receive your BZZ reward. This reward enables you to instantly join and participate in the Swarm
            network in one step.
          </div>
          <div>
        ...
        <div className="how-does-it-work-page__box">
          ...
          <div className="how-does-it-work-page__box__content">
            <a id="bzz-link" href="https://www.ethswarm.org/get-bzz" target="_blank" rel="noopener noreferrer">
              BZZ
            </a>{" "}
            is the native token of Swarm that grants users access to data relay and storage services while also serving as compensation for node
            operators who provide these services.
          </div>
        </div>
      </div>
    </div>
