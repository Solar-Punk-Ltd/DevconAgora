      ...
      <div className="how-does-it-work-page__content">
        ...
        <div className="how-does-it-work-page__box">
          ...
          <div className="how-does-it-work-page__box__content">
            Every time you make a valuable comment in the devcon.buzz application you make one step towards getting your
        ...
        <div className="how-does-it-work-page__box">
          ...
          <div className="how-does-it-work-page__box__content">
            Once you reach 10 comments you get your own personal code, that helps you to be part of the Swarm network
            yourself the easiest possible way.
          </div>
          <div>
